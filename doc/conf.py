# -*- coding: utf-8 -*-
#
# pyblk documentation build configuration file, created by
...
latex_documents = [
  ('index', 'pyblk.tex', u'pyblk Documentation',
   u'mulhern', 'manual'),
]
...
man_pages = [
    ('index', 'pyblk', u'pyblk Documentation',
     [u'mulhern'], 1)
]
...
texinfo_documents = [
  ('index', 'pyblk', u'pyblk Documentation',
   u'mulhern', 'pyblk', 'One line description of project.',
   'Miscellaneous'),
]
